...
This WC asks you to select and apply appropriate proof techniques.

# Background and Requirements

To attempt and submit the task you will need
- to recall the proof techniques done in class
- to read and understand statements written in logical syntax
- to select appropriate techniques for a required proof
